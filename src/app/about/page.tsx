...
export default function AboutPage() {
  return (
    <main className="flex flex-col min-h-screen w-full bg-gradient-to-b">
      {/* Hero Section */}
      ...
      <section className="w-full flex flex-col items-center py-8 px-6 md:px-16 lg:px-32">
        <h2 className="text-2xl font-bold mb-8 text-blue-800 dark:text-blue-300">Life Milestones</h2>
        <div className="max-w-4xl w-full border-l-4 border-blue-200 pl-8">
          <div className="mb-8">
            <span className="font-bold text-blue-700 dark:text-blue-300">2027+:</span> Launching my own AI startup, building innovative ai agents to solve real-world problems and empower organizations.
          </div>
          <div className="mb-8">
            <span className="font-bold text-blue-700 dark:text-blue-300">2027:</span> Retired from the Marine Corps with 24+ years of faithfulservice.
          </div>
          <div className="mb-8">
            <span className="font-bold text-blue-700 dark:text-blue-300">2025:</span> Graduated from UC Berkeley, launching a new chapter as a data scientist focused on generative AI.
          </div>
          <div className="mb-8">
            <span className="font-bold text-blue-700 dark:text-blue-300">2020:</span> Led AI-driven cyber operations at Marine Forces Cyber Command, integrating advanced analytics into defense.
          </div>
          <div className="mb-8">
            <span className="font-bold text-blue-700 dark:text-blue-300">2017:</span> Become one of the first Cyberspace Warfare Officers, pioneering new capabilities for the USMC.
          </div>
          <div className="mb-8">
            <span className="font-bold text-blue-700 dark:text-blue-300">2003:</span> Enlisted in the Marine Corps, beginning a journey of leadership and technical growth.
          </div>
        </div>
      </section>
      {/* Vision Statement */}
      <section className="w-full flex justify-center py-12 px-6 md:px-16 lg:px-32">
        <div className="max-w-2xl w-full bg-blue-50 dark:bg-gray-800/50 border-l-4 border-blue-400 p-8 rounded-xl text-center text-lg font-semibold shadow">
